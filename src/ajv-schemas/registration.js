            ...
            if (Array.isArray(data1)) {
              ...
              for (var i1 = 0; i1 < data1.length; i1++) {
                ...
                if (typeof data2 !== "string") {
                  validate.errors = [{
                    keyword: 'type',
                    dataPath: (dataPath || '') + '.credential_formats_supported[' + i1 + ']',
                ...
                var schema2 = validate.schema.properties.credential_formats_supported.items.enum;
                var valid2;
                valid2 = false;
                ...
                if (Array.isArray(data1)) {
                  ...
                  for (var i1 = 0; i1 < data1.length; i1++) {
                    ...
                    if (typeof data1[i1] !== "string") {
                      validate.errors = [{
                        keyword: 'type',
                        dataPath: (dataPath || '') + '.did_methods_supported[' + i1 + ']',
                ...
                if (valid1) {
                  if (data.id_token_encrypted_response_enc === undefined) {
                    ...
                    if (typeof data.id_token_encrypted_response_enc !== "string") {
                      validate.errors = [{
                        keyword: 'type',
                        dataPath: (dataPath || '') + '.id_token_encrypted_response_enc',
                      ...
                      if (Array.isArray(data1)) {
                        ...
                        for (var i1 = 0; i1 < data1.length; i1++) {
                          ...
                          if (typeof data2 !== "string") {
                            validate.errors = [{
                              keyword: 'type',
                              dataPath: (dataPath || '') + '.id_token_signing_alg_values_supported[' + i1 + ']',
                          ...
                          var schema2 = validate.schema.properties.id_token_signing_alg_values_supported.items.enum;
                          var valid2;
                          valid2 = false;
                          for (var i2 = 0; i2 < schema2.length; i2++)
                            if (equal(data2, schema2[i2])) {
                        ...
                        validate.errors = [{
                          keyword: 'type',
                          dataPath: (dataPath || '') + '.id_token_signing_alg_values_supported',
                                  ...
                                  if (Array.isArray(data1)) {
                                    ...
                                    for (var i1 = 0; i1 < data1.length; i1++) {
                                      ...
                                      if (typeof data1[i1] !== "string") {
                                        validate.errors = [{
                                          keyword: 'type',
                                          dataPath: (dataPath || '') + '.redirect_uris[' + i1 + ']',
                                    ...
                                    if (Array.isArray(data1)) {
                                      ...
                                      for (var i1 = 0; i1 < data1.length; i1++) {
                                        ...
                                        if (typeof data2 !== "string") {
                                          validate.errors = [{
                                            keyword: 'type',
                                            dataPath: (dataPath || '') + '.request_object_signing_alg_values_supported[' + i1 + ']',
                                        ...
                                        var schema2 = validate.schema.properties.request_object_signing_alg_values_supported.items.enum;
                                        var valid2;
                                        valid2 = false;
                                        for (var i2 = 0; i2 < schema2.length; i2++)
                                          if (equal(data2, schema2[i2])) {
                                      ...
                                      validate.errors = [{
                                        keyword: 'type',
                                        dataPath: (dataPath || '') + '.request_object_signing_alg_values_supported',
                                    ...
                                    if (data1 === undefined) {
                                      ...
                                      if (Array.isArray(data1)) {
                                        if (data1.length < 1) {
                                          validate.errors = [{
                                            keyword: 'minItems',
                                            dataPath: (dataPath || '') + '.response_types_supported',
                                          ...
                                          if (data1.length > 0) {
                                            ...
                                            if (typeof data2 !== "string") {
                                              validate.errors = [{
                                                keyword: 'type',
                                                dataPath: (dataPath || '') + '.response_types_supported[' + 0 + ']',
                                            ...
                                            var schema2 = validate.schema.properties.response_types_supported.items[0].enum;
                                            var valid2;
                                            valid2 = false;
                                            for (var i2 = 0; i2 < schema2.length; i2++)
                                              if (equal(data2, schema2[i2])) {
                                            ...
                                            if (data1.length > 1) {
                                              for (var i1 = 1; i1 < data1.length; i1++) {
                                                ...
                                                if (typeof data2 !== "string") {
                                                  var err = {
                                                    keyword: 'type',
                                                    dataPath: (dataPath || '') + '.response_types_supported[' + i1 + ']',
                                                ...
                                                var schema3 = validate.schema.properties.response_types_supported.additionalItems.anyOf[0].enum;
                                                var valid3;
                                                valid3 = false;
                                        ...
                                        if (Array.isArray(data1)) {
                                          ...
                                          for (var i1 = 0; i1 < data1.length; i1++) {
                                            ...
                                            if (typeof data2 !== "string") {
                                              validate.errors = [{
                                                keyword: 'type',
                                                dataPath: (dataPath || '') + '.scopes_supported[' + i1 + ']',
                                            ...
                                            var schema2 = validate.schema.properties.scopes_supported.items.enum;
                                            var valid2;
                                            valid2 = false;
                                            for (var i2 = 0; i2 < schema2.length; i2++)
                                              if (equal(data2, schema2[i2])) {
                                          ...
                                          validate.errors = [{
                                            keyword: 'type',
                                            dataPath: (dataPath || '') + '.scopes_supported',
                                          ...
                                          if (Array.isArray(data1)) {
                                            ...
                                            for (var i1 = 0; i1 < data1.length; i1++) {
                                              ...
                                              if (typeof data1[i1] !== "string") {
                                                validate.errors = [{
                                                  keyword: 'type',
                                                  dataPath: (dataPath || '') + '.subject_identifier_types_supported[' + i1 + ']',
                                            ...
                                            validate.errors = [{
                                              keyword: 'type',
                                              dataPath: (dataPath || '') + '.subject_identifier_types_supported',
                                            ...
                                            if (Array.isArray(data1)) {
                                              ...
                                              for (var i1 = 0; i1 < data1.length; i1++) {
                                                ...
                                                if (typeof data2 !== "string") {
                                                  validate.errors = [{
                                                    keyword: 'type',
                                                    dataPath: (dataPath || '') + '.subject_types_supported[' + i1 + ']',
                                                ...
                                                var schema2 = validate.schema.properties.subject_types_supported.items.enum;
                                                var valid2;
                                                valid2 = false;
                                                for (var i2 = 0; i2 < schema2.length; i2++)
                                                  if (equal(data2, schema2[i2])) {
                                              ...
                                              validate.errors = [{
                                                keyword: 'type',
                                                dataPath: (dataPath || '') + '.subject_types_supported',
...
validate.schema = {
  ...
  "required": ["authorization_endpoint", "credential_formats_supported", "id_token_signing_alg_values_supported", "issuer", "request_object_signing_alg_values_supported", "response_types_supported", "scopes_supported", "subject_identifier_types_supported", "subject_types_supported"],
  "type": "object"
};
